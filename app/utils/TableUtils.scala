...
import models.Tables.{ExpressionRow, GenomeRow}
...
object TableUtils {
  ...
  var genomeSeq : Seq[GenomeRow] = Seq()

  var geneIdSeq : Seq[String] = Seq()

  var chrMap : Seq[String] = Seq()

  var expressionMap : Seq[ExpressionRow] = Seq()

  var geneToId : Map[String,Int] = Map()
